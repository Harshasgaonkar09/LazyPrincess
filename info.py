...
DATABASE_NAME = environ.get('DATABASE_NAME', "Scooby")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1001856149007'))
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Scooby_Men') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','theottservice') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','theottservice') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Ultimately-YT09')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "Cinematic_xone") #[ without @ ]
...
lazy_groups = environ.get('LAZY_GROUPS','-1002095582844')
LAZY_GROUPS = [int(lazy_groups) for lazy_groups in lazy_groups.split()] if lazy_groups else None # ADD GROUP ID IN THIS VARIABLE
my_users = [int(my_users) if id_pattern.search(my_users) else my_users for my_users in environ.get('MY_USERS', '1124414278').split()]
...
DOWNLOAD_TEXT_URL = "https://t.me/download_t/14"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/theottservice"
